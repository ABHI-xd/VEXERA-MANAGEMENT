...
from VEXERA import dispatcher, updater, SUPPORT_CHAT
from VEXERA.modules.log_channel import gloggable
...
from VEXERA.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "SNEHABHI CHATBOT ENABLED BY @SNEHABHI_UPDATES",
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "SNEHABHI CHATBOT DISABLED BY @SNEHABHI_UPDATES",
                parse_mode=ParseMode.HTML,
            )
