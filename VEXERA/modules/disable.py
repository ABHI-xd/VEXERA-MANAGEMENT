...
from VEXERA.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from VEXERA.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from VEXERA.modules.sql import disable_sql as sql
