...
import VEXERA.modules.sql.global_bans_sql as sql
from VEXERA.modules.sql.users_sql import get_user_com_chats
from VEXERA import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from VEXERA.modules.helper_funcs.misc import send_to_list
